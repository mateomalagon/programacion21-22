...
System.out.println("Contesta a las preguntas con *v* si es verdadero y con *f* si es falso.\n");
...
if ( puntos <= 10 ) {
System.out.print("Has conseguido una puntuación de menos de 10 puntos ¡Enhorabuena! tu pareja parece ser totalmente fiel.");
}
if ( (puntos > 11 ) && (puntos <= 22) ) {
System.out.print("Has conseguido una puntuación de entre 11 y 22 puntos. Quizás exista el peligro de otra persona en su vida o en su mente, aunque seguramente será algo sin importancia. No bajes la guardia.");
}
if ( puntos >= 22 ) {
System.out.print("Has conseguido una puntuación de entre 22 y 30 puntos. Tu pareja tiene todos los ingredientes para estar viviendo un romance con otra persona. Te aconsejamos que indagues un poco más y averigües qué es lo que está pasando por su cabeza.");
    }
  }
}
